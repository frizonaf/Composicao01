...
public class ComposicaoApp {
	...
	public static void main(String[] args) throws ParseException {
		...
		Worker worker = new Worker(workerName, WorkerLevel.valueOf(level), baseSalary, new Department(department));	// worker instanciado
		...
		for (int i = 0; i < numberContracts; i++) {
			...
			HourContract newContract= new HourContract(contractDate,valuePerHour,duration);
